...
However, for America, because of the non-stationary, the fitting effect is not good. 
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=.99\textwidth]{america_pets_forecast_k0.png}
	\caption{Predicted Cat and Dog Population in America (k=0)}
\end{figure}
\clearpage
\begin{figure}[htbp]
	\centering
	\includegraphics[width=.99\textwidth]{america_pets_forecast_k1.png}
	\caption{Predicted Cat and Dog Population in America (k=1)}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=.99\textwidth]{america_pets_forecast_k2.png}
