...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=.99\textwidth]{Figure_22.png}
	\caption{judgment value}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=.99\textwidth]{Figure_21.png}
	\caption{auxiliary value}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=.99\textwidth]{Figure_23.png}
